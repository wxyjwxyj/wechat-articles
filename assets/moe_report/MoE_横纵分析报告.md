...
#### DeepSeek V3.2（2026.3）

V3.2 修复了"极"字 bug，进一步优化推理能力，支持 1M 上下文，并在训练稳定性上做了改进。DeepSeek V4 也已在 Preview 阶段。
...
| DeepSeek V3.2 | 2026.03 | 685B | ~37B | 256+1 | 8+1 | 修复"极"bug、1M上下文 | ✅ |
...
| 模型 | MMLU | HumanEval | AIME 2024 | SWE-bench | 测试时间 |
|------|------|-----------|-----------|-----------|---------|
| Mixtral 8x7B | 70.6% | 40.2% | — | — | 2023.12 |
| Mixtral 8x22B | 77.7% | 45.1% | — | — | 2024.04 |
| DeepSeek-V2 | ~78% | ~76% | — | — | 2024.05 |
| DeepSeek-V3 | 88.5% | 89.1% | — | 45.4 | 2024.12 |
| DeepSeek R1 | 90.8% | — | 79.8% | — | 2025.01 |
| DeepSeek V3.1 | 88.5% | — | — | 66.0 | 2025.08 |
| Qwen3-235B | ~89% | — | 85.7% | — | 2025 |
| Mistral Large 3 | 85.5% | 92.0% | 73.6 | — | 2025.12 |
| GPT-4 | 86.4% | 88.4% | — | — | 2023.03 |
| Gemini 3.1 Pro | 92.6% | — | — | 80.6 | 2026.02 |
| Grok-4 Heavy | — | — | ~100% | — | 2026 |
| Claude 3.5 Sonnet | ~88% | ~91% | — | — | 2024.06 |

**注**：不同模型的评测设置和时间不同，分数不完全可比。HumanEval 正在被社区弃用（饱和度过高），新模型倾向报告 LiveCodeBench / SWE-bench。AIME 2024 是数学推理的硬指标。"—"表示该模型未公开对应数据。
...
| DeepSeek R1 (2025) | 论文 | Nature 封面 (2025.9) / arXiv |
...
| Gemini 3.1 Pro | ZDNET 等 | https://www.zdnet.com/article/google-gemini-3-1-pro-release-ai-model/ |
| Grok-4 Heavy | Scientific American | https://www.scientificamerican.com/ |
