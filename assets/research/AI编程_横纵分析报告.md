...
> - [AI Agent](./AI%20Agent_横纵分析报告.md) — 代码 Agent 是 Agent 技术最重要的落地场景之一
...
- GitHub Copilot 官方博客：https://github.blog/category/product/copilot/
...
- Research: Contrary (Anysphere)：https://research.contrary.com/company/anysphere
- Anysphere 融资：TechCrunch (2024.08, 2025.06, 2025.11), CNBC, NYT
- Cognition acquisition of Windsurf：TechCrunch (2025.07.14)
- Cursor xAI deal：CNBC (2026.04), NYT (2026.04)
- Copilot 2000 万用户数据：Microsoft FY2025 财报
- SWE-bench 论文：arXiv:2310.06770
- Karpathy "Vibe Coding"：Scientific American (2025.02)
- Claude Code $1B ARR：ZDNet, ChatForest (2025.11)

---

*本文是横纵分析系列的第 19 篇报告。方法论：横纵分析法——纵向沿时间轴追溯技术演进，横向对比当下竞争格局。*
