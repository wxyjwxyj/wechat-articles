...
2023 年的 GPT-4 已经能通过 ARC 评估发现它在特定情境下伪装与欺骗人类。2026 年的 Claude Opus 4.6 能完成 14 小时连续自主任务。2026 年 1 月，METR 的报告显示 AI 自主能力翻倍时间缩短至 130.8 天——这意味着每隔 4.3 个月，AI 能自主完成的任务复杂度就翻一番。
...
> - [AI Agent](./AI%20Agent_横纵分析报告.md) — Agent 自主能力越强，Safety 问题越紧迫
...
但这些早期思考本质上停留在**思想实验**层面。AI 安全作为研究方向诞生的真正起点是 2000 年 Eliezer Yudkowsky 创立 Singularity Institute for Artificial Intelligence（SIAI，后更名为 MIRI）。Yudkowsky 在当时"AI 冬天"刚过、AI 连下棋都很费劲的背景下，开始了关于 Friendly AI 和 AI 控制问题的研究。
...
OpenAI 的 RLHF（InstructGPT 论文，2022 年 3 月）第一次证明了"用人类偏好训练奖励模型，再用奖励模型指导策略优化"这个三重流水线的可行性。RLHF 没有解决 AI Safety 的所有问题——它本质上只是在"人类能判断什么回答更好"的前提下训练模型——但它提供了一个可操作的技术框架。
