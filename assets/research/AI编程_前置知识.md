...
GitHub Copilot（2021 年推出）把这种能力带给了全世界。
...
**好处**：不用换编辑器，上手最快，用户基数最大（Copilot 2025 年累积 2000 万+用户）
...
SWE-bench（Software Engineering Benchmark）是普林斯顿大学在 2023 年推出的基准测试，用来衡量 AI 编程的真实能力。
...
2023 年刚推出时，最好的 AI 系统只能解决不到 2% 的问题。到 2026 年 4 月，Claude Opus 4.7 能解决 87.6%（Verified 版本）。这个进步速度本身就是一个故事。
...
| 产品 | 开发商 | 形态 | 核心特点 |
|------|--------|------|---------|
| **GitHub Copilot** | GitHub/Microsoft | VS Code 插件 | 用户基数最大（2000 万+），微软生态，支持多模型 |
| **Cursor** | Anysphere | Fork IDE | 编辑体验最丝滑，多模型切换，2026 年估值 $60B |
| **Claude Code** | Anthropic | CLI Agent | Agent 能力最强，只调用 Claude 模型，开发者中最极客的选择 |
