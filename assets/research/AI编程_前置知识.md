...
2023 年刚推出时，最好的 AI 系统只能解决不到 2% 的问题（Jimenez et al., Princeton, 2024）。到 2026 年 4 月，Claude Opus 4.7 能解决 87.6%（Verified 版本）。这个进步速度本身就是一个故事。
...
| **Cursor** | Anysphere | Fork IDE | 编辑体验最丝滑，多模型切换，2026 年估值 $60B（Anysphere） |
