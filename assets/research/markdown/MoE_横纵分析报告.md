...
> **2026 年 5 月更新**：DeepSeek V4 正式发布——1.6T 参数 MoE（384 专家/激活 6 个），1M 上下文，同步适配 NVIDIA Blackwell 与华为昇腾。Yifan Zhang 公开的 V4 技术规格和梁文锋署名的 V4 技术报告披露了 mHC（流形约束超连接）、CSA+HCA 混合稀疏注意力等四大核心创新。Megatron Core 同期发布 MoE 可扩展训练技术报告，NVFP4 训练在 Blackwell 上实现 3 倍加速。
...
> **📚 关联报告**
> - [Transformer](./Transformer_横纵分析报告.md) — MoE 替换的是 Transformer 的 FFN 层，理解 Transformer 是理解 MoE 的前提
> - [LLM 基础大模型](./LLM大模型_横纵分析报告.md) — DeepSeek、Mixtral 等 MoE 模型是 LLM 赛道的重要玩家
> - [模型压缩](./模型压缩_横纵分析报告.md) — MoE 显存占用大，量化/蒸馏等压缩技术对 MoE 部署至关重要
> - [大模型训练](./大模型训练_横纵分析报告.md) — MoE 的专家并行需要专门的分布式训练框架支持
...
**2013 年是一个被低估的节点。** David Eigen、Marc'Aurelio Ranzato、Ilya Sutskever（后来 OpenAI 的联合创始人）发表了《Learning Factored Representations in a Deep Mixture of Experts》。这篇论文第一次尝试把 MoE 的门控机制嵌入到深度神经网络的每一层——这正是今天 Transformer MoE 的雏形。
...
| 论文/文章 | 来源 | 访问时间 |
|-----------|------|---------|
| Adaptive Mixtures of Local Experts (1991) | Jacobs, Jordan, Nowlan, Hinton — Neural Computation 3(1) | 2026-04-30 |
| Hierarchical Mixtures of Experts (1994) | Jordan & Jacobs — Neural Computation 6(2) | 2026-04-30 |
| Deep Mixture of Experts (2013) | arxiv.org/abs/1312.4314 | 2026-04-30 |
| Exploring the Limits of Language Modeling (2016) | arxiv.org/abs/1602.02410 | 2026-04-30 |
| Sparsely-Gated MoE (2017) | arxiv.org/abs/1701.06538 | 2026-04-30 |
| GShard (2020) | arxiv.org/abs/2006.16668 | 2026-04-30 |
| Switch Transformer (2021) | arxiv.org/abs/2101.03961 | 2026-04-30 |
| GLaM (2021) | arxiv.org/abs/2112.06905 | 2026-04-30 |
| ST-MoE (2022) | arxiv.org/abs/2202.08906 | 2026-04-30 |
| DeepSeek-V2 (2024) | arxiv.org/abs/2405.04434 | 2026-04-30 |
| DeepSeek-V3 (2024) | arxiv.org/abs/2412.19437 | 2026-04-30 |
| DeepSeek R1 (2025) | arxiv.org/abs/2501.12948 | 2026-04-30 |
| DeepSeek V3.2 (2025) | arxiv.org/abs/2512.02556 | 2026-04-30 |
| DeepSeek mHC | arxiv.org/abs/2512.24880 | 2026-04-30 |
| Baidu ERNIE 5.0 (2026.01) | arxiv.org/abs/2602.04705 | 2026-04-30 |

### 产品与技术来源

| 来源 | URL | 访问时间 |
|------|-----|---------|
| Mixtral 8x7B (2023) | mistral.ai/news/mixtral-of-experts/ | 2026-04-30 |
| Grok-1 (2024) | x.ai/blog/grok-os | 2026-04-30 |
| DeepSeek V3.1 (2025) | DeepSeek API Docs | 2026-04-30 |
| DeepSeek V4 (2026.04) | developer.nvidia.com/blog/build-with-deepseek-v4 | 2026-04-30 |
| Qwen3-MoE / Qwen3.5 | qwenlm.github.io/blog/ | 2026-04-30 |
| Qwen3-Next | developer.nvidia.com/blog/new-open-source-qwen3-next-models/ | 2026-04-30 |
| Qwen3.6-Plus (2026.04) | developer.aliyun.com/article/1724039 | 2026-04-30 |
| Xiaomi MiMo-V2.5 (2026.04) | HuggingFace: Xiaomi-MiMo | 2026-04-30 |
| Zhipu GLM-5.1 (2026.04) | ithome.com/html/937186.htm | 2026-04-30 |
| Mistral Large 3 / Small 4 | mistral.ai/ | 2026-04-30 |
| Kimi K2 | github.com/moonshotai/Kimi-K2 | 2026-04-30 |
| Kimi K2.6 (2026.04) | zdnet.com/article/moonshot-ai-kimi-k2-6 | 2026-04-30 |
| Llama 4 Scout/Maverick | Meta AI 博客 | 2026-04-30 |
| Google Gemma 4-26B (2026.04) | Google AI 博客 | 2026-04-30 |
| Gemini 3.1 Pro (2026.02) | zdnet.com/article/google-gemini-3-1-pro-release-ai-model/ | 2026-04-30 |
...
*本文是横纵分析系列的第 2 篇报告。方法论：横纵分析法——纵向沿时间轴追溯技术演进，横向对比当下竞争格局。*
