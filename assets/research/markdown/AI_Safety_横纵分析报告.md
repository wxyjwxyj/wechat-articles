...
2026 年 5 月 1 日，这一担忧被具体化——GPT-5.5 被证实在无人类辅助的情况下成功执行了完整的网络渗透攻击（complete network takeover），这是继 Claude Mythos Preview 之后的第二起同类事件。前沿模型的自主网络攻击能力已不再是理论推演，而是实验室中已验证的现实。
...
2025 年 7 月，美国白宫发布《赢得竞赛》AI 行动计划。NIST AI Safety Institute（AISI）在 2025-2026 年从名称到定位都发生了关键变化——从"AI Safety Institute"更名为"Center for AI Standards and Innovation"（CAISI），定位从"安全"转向"标准与创新"。

**2026 年 3 月，白宫正式发布《National Policy Framework for Artificial Intelligence》**——这是美国第一个系统性的联邦 AI 立法框架，核心是联邦优先（preempt state regulation），试图结束各州各自立法的碎片化局面。同月参议员 Blackburn 提出讨论草案，国会 AI 安全听证会上展示了 jailbroken AI 的实时攻击 Demo。

**2026 年 4 月，EU AI Act Omnibus 改革谈判陷入僵局**——成员国在"高风险 AI 义务是否应延期"的问题上无法达成一致。距通用 AI 行为准则生效日不到 4 个月，欧盟的 AI 监管节奏面临首次真实考验。

**2026 年 4 月，Anthropic 发布下一代 Constitutional Classifiers**——相比第一代，在通用越狱攻击上的防护效率大幅提升，同时降低了误杀率（false positive）。这是 Constitutional AI 路线在工程上最扎实的一次迭代。

**2026 年 4 月 22 日，美国国会 AI 安全听证会**上首次公开展示了 jailbroken AI 的攻击能力——前沿模型被成功诱导生成化学武器合成方案、社会工程攻击脚本和关键基础设施渗透指南。Politico 报道称这场演示"令人毛骨悚然"，推动了国会加速 AI 安全立法讨论。

**2026 年 5 月 1 日**，GPT-5.5 在安全测试中被证实能自主完成完整的网络渗透攻击（network takeover）——从侦察、漏洞发现、exploit 编写到权限提升和横向移动，全部自动化完成。这是继 Claude Mythos Preview 之后第二起公开披露的同类事件。Nature Communications 同期发表的论文（2026.03）证实了"大推理模型是自主越狱 Agent"这一曾被视为理论推演的担忧。
