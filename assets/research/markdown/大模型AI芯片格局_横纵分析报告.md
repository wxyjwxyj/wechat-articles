...
> - [大模型训练](./大模型训练_横纵分析报告.md) — 万卡集群如何把芯片的算力"组装"起来
> - [模型压缩](./模型压缩_横纵分析报告.md) — 量化/蒸馏如何降低对高端芯片的依赖
> - [大模型推理部署](./大模型推理部署_横纵分析报告.md) — 推理芯片需求与训练截然不同
> - [前置知识](./大模型AI芯片格局_前置知识.md) — 理解 GPU/CPU 区别、矩阵乘法和三个核心指标的基础概念
...
*本文是横纵分析系列的第 3 篇报告。方法论：横纵分析法——纵向沿时间轴追溯技术演进，横向对比当下竞争格局。*
